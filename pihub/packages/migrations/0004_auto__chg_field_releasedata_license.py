...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReleaseData.license'
        db.alter_column('packages_releasedata', 'license', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'ReleaseData.license'
        db.alter_column('packages_releasedata', 'license', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
