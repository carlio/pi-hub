...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('packages_releaseurl', 'field_hash', self.gf('django.db.models.fields.CharField')(default='', max_length=32))

    def backwards(self, orm):

        # Changing field 'ReleaseData.field_hash'
        db.alter_column('packages_releaseurl', 'field_hash', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
