...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MirrorState.index_fetch_status'
        db.add_column('packages_mirrorstate', 'index_fetch_status',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Release.fetch_status'
        db.add_column('packages_release', 'fetch_status',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MirrorState.index_fetch_status'
        db.delete_column('packages_mirrorstate', 'index_fetch_status')

        # Deleting field 'Release.fetch_status'
        db.delete_column('packages_release', 'fetch_status')
    ...
    models = {
        'packages.mirrorstate': {
            ...
            'index_fetched': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'packages.pkg': {
