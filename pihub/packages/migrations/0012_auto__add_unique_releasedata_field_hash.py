...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ReleaseData', fields ['field_hash']
        db.create_index('packages_releasedata', ['field_hash'])

        # Adding unique constraint on 'ReleaseData', fields ['field_hash']
        db.create_unique('packages_releasedata', ['field_hash'])


    def backwards(self, orm):
        # Removing unique constraint on 'ReleaseData', fields ['field_hash']
        db.delete_unique('packages_releasedata', ['field_hash'])

        # Removing index on 'ReleaseData', fields ['field_hash']
        db.delete_index('packages_releasedata', ['field_hash'])
