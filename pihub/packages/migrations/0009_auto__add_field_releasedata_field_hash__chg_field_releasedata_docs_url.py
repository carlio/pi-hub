...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReleaseData.field_hash'
        db.add_column('packages_releasedata', 'field_hash',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True),
                      keep_default=False)


        # Changing field 'ReleaseData.docs_url'
        db.alter_column('packages_releasedata', 'docs_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    ...
    def backwards(self, orm):
        # Deleting field 'ReleaseData.field_hash'
        db.delete_column('packages_releasedata', 'field_hash')


        # Changing field 'ReleaseData.docs_url'
        db.alter_column('packages_releasedata', 'docs_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
