...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReleaseData.release'
        db.alter_column('packages_releasedata', 'release_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['packages.Release'], unique=True))
        # Adding unique constraint on 'ReleaseData', fields ['release']
        db.create_unique('packages_releasedata', ['release_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ReleaseData', fields ['release']
        db.delete_unique('packages_releasedata', ['release_id'])


        # Changing field 'ReleaseData.release'
        db.alter_column('packages_releasedata', 'release_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['packages.Release']))
