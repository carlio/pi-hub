...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReleaseUrl.upload_time'
        db.alter_column('packages_releaseurl', 'upload_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ReleaseUrl.upload_time'
        raise RuntimeError("Cannot reverse this migration. 'ReleaseUrl.upload_time' and its values cannot be restored.")
