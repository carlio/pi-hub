...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MirrorState.index_fetched'
        db.delete_column('packages_mirrorstate', 'index_fetched')


    def backwards(self, orm):
        # Adding field 'MirrorState.index_fetched'
        db.add_column('packages_mirrorstate', 'index_fetched',
