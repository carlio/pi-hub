...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReleaseUrl.downloads'
        db.alter_column('packages_releaseurl', 'downloads', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ReleaseUrl.size'
        db.alter_column('packages_releaseurl', 'size', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ReleaseUrl.downloads'
        raise RuntimeError("Cannot reverse this migration. 'ReleaseUrl.downloads' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ReleaseUrl.size'
        raise RuntimeError("Cannot reverse this migration. 'ReleaseUrl.size' and its values cannot be restored.")
